...
def _bilesenleri_topla_kapanis(cur: Any, sube_id: str, tarih: Any) -> Dict[str, float]:
    ...
    # KP2 NOT (2026-07-06): z_nakit yalnız durum='aktif' (onaylı) ciro'dan okunur — DOĞRU davranış.
    # "Taslak onaylanmadan recalc → z_nakit=0" endişesi KP3 sonrası geçersiz: recalc tek tetikleme
    # noktasına indirildi ve ciro onayından SONRA çalışıyor. Aktif ciro yokken (ciro_sil/iptal) z_nakit
    # gerçekten 0 olmalı; taslak fallback iptal edilen nakiti diriltirdi → eklenmiyor. YANLIŞ-POZİTİF.
