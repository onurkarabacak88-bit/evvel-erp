...
class VardiyaDevirAdim1(BaseModel):
    ...
    pasta_adet: int = Field(0, ge=0)
    # Bireysel pasta kalemleri
    pasta_porsiyon_sade: int = Field(0, ge=0)
    pasta_porsiyon_antep: int = Field(0, ge=0)
    pasta_porsiyon_cik: int = Field(0, ge=0)
    pasta_mag_cilek: int = Field(0, ge=0)
    pasta_mag_lotus: int = Field(0, ge=0)
    pasta_buyuk_tart: int = Field(0, ge=0)
    pasta_kucuk_tart: int = Field(0, ge=0)
    pasta_snickers: int = Field(0, ge=0)
    pasta_malaga: int = Field(0, ge=0)
    pasta_latte: int = Field(0, ge=0)
    pasta_muzlu_rulo: int = Field(0, ge=0)
    pasta_cik_rulo: int = Field(0, ge=0)
    pasta_meyveli_rulo: int = Field(0, ge=0)
    pasta_browni: int = Field(0, ge=0)
    pasta_dilim_ss_sade: int = Field(0, ge=0)
    pasta_cream_puff: int = Field(0, ge=0)
    pasta_kavala: int = Field(0, ge=0)
    pasta_cup_limon: int = Field(0, ge=0)
    pasta_cup_yerfistik: int = Field(0, ge=0)
    pasta_cup_cilek: int = Field(0, ge=0)
    pasta_cup_karamel: int = Field(0, ge=0)
    pasta_cup_lotus: int = Field(0, ge=0)
    pasta_cup_antep: int = Field(0, ge=0)
    pasta_cup_hindistan: int = Field(0, ge=0)
    pasta_profiterol: int = Field(0, ge=0)
    pasta_kare_cik: int = Field(0, ge=0)
    pasta_kare_yerfistik: int = Field(0, ge=0)
    pasta_kare_karamel: int = Field(0, ge=0)
    pasta_kare_limon: int = Field(0, ge=0)
    pasta_dilim_sade: int = Field(0, ge=0)
    pasta_dilim_antep: int = Field(0, ge=0)
    pasta_dilim_cik: int = Field(0, ge=0)
    pasta_dilim_yaban: int = Field(0, ge=0)
...
def legacy_kapanis_adim1(sube_id: str, body: dict = Body(...)):
    ...
    mapped = VardiyaDevirAdim1(
        ...
        **{k: _zint(k) for k in (
            ...
            "pasta_meyveli_rulo","pasta_browni","pasta_dilim_ss_sade","pasta_cream_puff","pasta_kavala",
            ...
            "pasta_kare_cik","pasta_kare_yerfistik","pasta_kare_karamel","pasta_kare_limon",
            "pasta_dilim_sade","pasta_dilim_antep","pasta_dilim_cik","pasta_dilim_yaban",
        )},
    )
