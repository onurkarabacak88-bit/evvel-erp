...
// ── 📒 CARİ EKSTRE PANELİ (2026-07-19, sahip: 'dünya klasmanında kullanım,
// sitenin profesyonelliğini kurgula' — Codex çaprazlı tasarım spec'i).
...
// kullanıcı satırdan kopmaz; yeni sekme ikincil aksiyon. Veri AYNI uçtan
// (cari-ekstre) — yalnız sunum katmanı; hesap değişmedi.
const trT = (d) => (d && d.length >= 10) ? `${d.slice(8, 10)}.${d.slice(5, 7)}.${d.slice(0, 4)}` : (d || '');
const trAy = (a) => { // '2026-07' → 'Tem 2026'
