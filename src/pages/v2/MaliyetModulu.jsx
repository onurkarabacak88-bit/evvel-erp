...
// 🔗 `kaynakAyir` + ZAM_KAYNAK_DAMGASI TAŞINDI (2026-08-16) → ZamTakibi.jsx.
// Tek kullanıcısı zam alarm listesiydi; görünüm Genel Bakış'a geçince yardımcı
// da onunla gitti (iki dosyada kopya bırakılmadı).
...
export default function MaliyetModulu({ gorunum, onCekmece, onKopru, onToast }) {
  ...
  // (alarm/eşik/geçmiş state'leri ZamTakibi.jsx'e taşındı — 2026-08-16)
  ...
  // ⚠️ AYRIŞTIRILDI (2026-08-15): eskiden zam alarm yükleyicisi KDV'yi de
  // çekiyordu; liste ayrı sekmeye taşınınca bağ koptu. Zam yükleyicisi
  // 2026-08-16'da görünümle birlikte ZamTakibi.jsx'e gitti.
  ...
  }, [gorunum, ozetYukle, receteYukle, kdvYukle, kontrolYukle, vergiYukle, gercekYukle]);
  ...
  if (gorunum === 'fiyat') {
    ...
    return (
      <>
        ...
        <button
          onClick={() => onKopru?.('__modul:genel:zam')}
          style={{
  ...
  // 📈 ZAM TAKİBİ TAŞINDI (2026-08-16) — sahip: "Zam Takibi, Karar Alanı ve
  // Para Akışı gibi YUKARIDA SEKME olarak dursun." Görünüm artık GENEL BAKIŞ
  // modülünde: src/pages/v2/ZamTakibi.jsx (paylaşılan bileşen).
  // Burada KOPYASI DURMAZ — yukarıdaki Fiyat Zinciri ekranında tek satır köprü
  // kaldı. `kaynakAyir` yardımcısı da görünümle birlikte taşındı (tek kullanıcı).
