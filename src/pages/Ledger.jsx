  ...
  return (
    <div className="page">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12, marginBottom: 16 }}>
        {[
          { label: '↑ Toplam Gelir', val: toplamGelir, renk: 'var(--green)' },
          { label: '↓ Toplam Gider', val: toplamGider, renk: 'var(--red)' },
          { label: '= Net Kasa', val: toplamGelir - toplamGider, renk: (toplamGelir - toplamGider) >= 0 ? 'var(--green)' : 'var(--red)' },
        ].map(({ label, val, renk }) => (
